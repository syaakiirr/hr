              ...
              {selectedForReport.size > 0 && (
                <>
                  ...
                  <button
                    onClick={async () => {
                      try {
                        await downloadMultiSessionReportExcel(Array.from(selectedForReport));
                      } catch (err) {
                ...
                <div className="engage-card-hd">
                  ...
                  <div className="stats-row" style={{ gap: 12, alignItems: "center" }}>
                    ...
                    <button
                      onClick={() => {
                        try {
                          downloadSessionReportExcel(selectedSession.sessionID, selectedSession.sessionDate);
                        } catch (err) {
                          alert(err instanceof Error ? err.message : "Failed to download Excel.");
                        }
                      }}
