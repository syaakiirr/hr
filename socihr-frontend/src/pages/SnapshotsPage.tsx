        ...
        <div className="page-hd">
          <div>
            ...
            <p className="page-sub">Historical dashboard states saved for comparison and reporting</p>
              ...
              <button onClick={async () => { const { downloadPageAsPDF } = await import("../utils/pdf"); downloadPageAsPDF("Snapshots"); }} className="btn btn-primary" style={{ display: "flex", alignItems: "center", gap: 6 }}>
